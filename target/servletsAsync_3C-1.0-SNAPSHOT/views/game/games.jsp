    ...
    <div class="abs-center">
            <form center>
                ...
                <div style="display: block;width: 70%;margin:10px auto">
                    <button type="button" id="btn-registrar" class="btn btn-success align-content-center"  /><i class="fas fa-check-square"></i> Registrar</button>
                    <button type="button" class="btn btn-danger align-content-center" data-bs-dismiss="modal"><i class="fas fa-times"></i> Cerrar</button>
                    <div id="status"></div>
                </div>
            </form>
    </div>
